...
<body>
  <div class="container-fluid">
    ...
    <div>
      ...
      <select class="form-select" aria-label="listadeautos" name="autoSeleccionado" id="autoSeleccionado">
	<option value="0" selected>Seleccione su auto</option>
	<c:forEach var="auto" items="${listaSelectAutos}">
	<option value="${auto.id}">${auto.marca} - ${auto.nombre}</option>
	</c:forEach>

	</select>
      <br>
      <button type="submit" class="btn btn-outline-secondary" value="filtrar">Filtrar auto</button>
      </form>
      <br>
      ...
      <table class="table table-striped">
        ...
        <tbody>
        	...
        	<td> <c:out value="${auto.nombre}"></c:out></td>
        	<td> <c:out value="${auto.color}"></c:out></td>
        	<td>${auto.usuario.correo}</td>
